...
Bundled with the Hermes Voice companion. Copying the `companion` directory during plugin install includes this source, the build script, and the browser-call runtime that consumes it.
...
Minimum supported operating system for this route is Windows 10 build 20348. The implementation follows the public API contract and was informed by Microsoft's Application Loopback sample.
