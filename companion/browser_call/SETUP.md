...
The Windows process-loopback helper compiles on demand from `companion/process_loopback/` using the C# compiler included with Windows. Generated binaries stay under `companion/browser_call/build/`, which git ignores.
