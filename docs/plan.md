...
> [!IMPORTANT]
> **Current execution decision, 2026-09-04:** [MVP-D01](mvp-d01-discord-voice.md) is the next bounded implementation under the [MVP roadmap](mvp-roadmap.md). Discord is first, browser work is deferred, and transcription is excluded. New/current task selection and mandatory model/effort verification remain required. [ADR 0004](adr/0004-discord-first-direct-audio.md) supersedes browser-first/post-v1 Discord wording below. Legacy feasibility gates do not block this runnable slice.
